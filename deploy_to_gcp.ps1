...
$PAYMENT_PREMIUM_AMOUNT     = $envVars["PAYMENT_PREMIUM_AMOUNT"]
$PAYMENT_UNLIMITED_AMOUNT   = $envVars["PAYMENT_UNLIMITED_AMOUNT"]
...
$envVarsString = "GOOGLE_CLIENT_ID=$GOOGLE_CLIENT_ID," +
                 ...
                 "PAYMENT_PREMIUM_AMOUNT=$PAYMENT_PREMIUM_AMOUNT," +
                 "PAYMENT_UNLIMITED_AMOUNT=$PAYMENT_UNLIMITED_AMOUNT," +
